# ****************************************************************
# this code is shamelessly copied from django-q-email joeyespo
# I figure anytime this needs maintaining I will have to do it myself
# If I can't fix a single page of code, there are other problems fml
# *****************************************************************
...
class DjangoQBackend(BaseEmailBackend):
    ...
    def send_messages(self, email_messages):
        ...
        for email_message in email_messages:
            ...
            async_task('pestimator.djangoQEmailBackend.send_message', email_message)
            num_sent += 1
        return num_sent
